        ...
        >
          <form onSubmit={handleLogin} className="space-y-7">
            ...
            <motion.div variants={itemVariants}>
              <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 ml-1 uppercase tracking-wider">Email Address</label>
              <input
                type="email"
                required
                value={email}
            ...
            <motion.div variants={itemVariants}>
              <div className="flex justify-between items-center mb-3">
                ...
                <Link href="#" className="text-xs font-bold text-emerald-600 hover:text-emerald-500 uppercase tracking-wider">Forgot?</Link>
              </div>
            ...
            >
              ...
              {!loading && (
                <motion.svg 
                  ...
                  className="w-6 h-6 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <motion.div variants={itemVariants} className="mt-12 text-center">
            <p className="text-slate-500 dark:text-slate-400 font-bold text-sm tracking-wide">
              New to the platform?{" "}
              <Link href="/register" className="text-emerald-600 hover:text-emerald-500 font-black relative group inline-block">
