...
const badges = [
  {
    id: "saver_initiate",
    title: "Saver Initiate",
    icon: Star,
    color: "bg-amber-400",
    desc: "First pre-booked meal",
    pts: 50,
  },
  {
    id: "green_streak",
          ...
          return (
            ...
            >
              ...
              >
                <Icon
                  size={32}
                  className={isUnlocked ? "text-white drop-shadow-lg" : "text-slate-400"}
                />
              ...
              <p
                className={`text-[10px] font-black uppercase tracking-[0.1em] italic leading-tight ${isUnlocked ? "text-slate-900 dark:text-white" : "text-slate-400"}`}
              >
                {badge.title}
              </p>
              <div
                className={`mt-2 px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest ${isUnlocked ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-slate-100/50 dark:bg-slate-800/50 text-slate-400"}`}
              >
