  ...
  const steps = [
    {
      ...
      content:
        "This is your central hub for tracking, managing, and predicting food waste impacts.",
      highlightClasses: "fixed top-20 left-1/2 -translate-x-1/2", // Mock highlight position
    },
    {
      title: "Quick Action Network",
      content:
        "Use these glowing core modules to immediately book meals, log inventory, or interface with partners.",
      highlightClasses: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",
    },
    {
      title: "Settings & Personalization",
      content:
        "Don't forget to configure your SMS alerts and UI mode in the Settings Engine below your Profile.",
      ...
      <div className="fixed inset-0 z-[100] pointer-events-none">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleNext}
              className="flex items-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-emerald-500/20 active:scale-95 group"
            >
              {step === steps.length - 1 ? (
                <>
